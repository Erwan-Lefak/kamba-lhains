...
export default function CrepusculePantalonCargo() {
  ...
  const cargoProducts = products.filter(product => {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Pantalons Cargo de la collection Crépuscule - Fonctionnalité et mystère urbain." />
