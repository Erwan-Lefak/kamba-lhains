...
export default function CrepusculeBaggyJeans() {
  ...
  return (
    <>
      <Head>
        <title>Baggy Jeans Crépuscule - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Baggy Jeans de la collection Crépuscule - Mystère et élégance pour vos soirées sophistiquées." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Baggy Jeans Crépuscule ${index + 1}`}
                    width={400}
                    height={600}
