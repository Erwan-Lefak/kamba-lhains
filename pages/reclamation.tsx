    ...
    <>
      ...
      <main style={{ padding: '60px 20px', fontFamily: 'Manrope, sans-serif' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ backgroundColor: '#f8f8f8', padding: '30px', marginBottom: '40px' }}>
          ...
          <div style={{ marginTop: '40px', padding: '20px', backgroundColor: '#f8f8f8', textAlign: 'center' }}>
            <h3 style={{ fontSize: '11px', fontWeight: '500', color: '#333', marginBottom: '15px' }}>
              AUTRES MOYENS DE CONTACT
            </h3>
            <div style={{ fontSize: '11px', color: '#666', lineHeight: '1.6' }}>
              <p style={{ marginBottom: '8px' }}>Email : info@kambalahains.net</p>
              <p style={{ marginBottom: '8px' }}>Téléphone : +33 (0) 1 58 30 03 84</p>
              <p>Horaires : Lundi au Vendredi 10h-13h et 14h-21h, Samedi 10h-13h et 14h-18h CET</p>
            </div>
          </div>
        </div>
      </main>
