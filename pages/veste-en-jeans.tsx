...
export default function CrepusculeVesteEnJeans() {
  ...
  return (
    <>
      <Head>
        <title>Veste en Jeans Crépuscule - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Vestes en Jeans de la collection Crépuscule - Style rebelle et mystère nocturne." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Veste en Jeans Crépuscule ${index + 1}`}
                    width={400}
                    height={600}
