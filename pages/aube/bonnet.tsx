...
export default function AubeBonnet() {
  ...
  const bonnetProducts = products.filter(product => {
    ...
    const descriptionMatch = Array.isArray(product.description) 
      ? product.description.some(desc => desc.toLowerCase().includes('bonnet'))
  ...
  return (
    <>
      <Head>
        <title>Bonnet - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Bonnets Aube - Fraîcheur et élégance pour vos matinées lumineuses." />
