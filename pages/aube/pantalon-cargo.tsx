...
export default function AubePantalonCargo() {
  ...
  const pantalonCargoProducts = products.filter(product => {
    ...
    const nameMatch = product.name.toLowerCase().includes('cargo') || 
  ...
  return (
    <>
      <Head>
        <title>Pantalon Cargo - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Pantalons Cargo Aube - Fraîcheur et élégance pour vos matinées lumineuses." />
