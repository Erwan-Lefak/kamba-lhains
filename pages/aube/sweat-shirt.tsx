...
export default function AubeSweatShirt() {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Sweat-Shirts Aube - Fraîcheur et élégance pour vos matinées lumineuses." />
