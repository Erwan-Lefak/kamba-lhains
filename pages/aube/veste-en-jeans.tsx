...
export default function AubeVesteEnJeans() {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Vestes en Jeans Aube - Fraîcheur et élégance pour vos matinées lumineuses." />
