...
export default function AubeCasquette() {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Casquettes Aube - Fraîcheur et élégance pour vos matinées lumineuses." />
