        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <div className="content">
              <p>Les présentes conditions générales de vente régissent les relations contractuelles entre Kamba Lhains et ses clients dans le cadre de la vente en ligne de vêtements et accessoires de mode sur le site kambalhains.com.</p>
            </div>
          </section>
          ...
          <section className="section">
            ...
            <div className="content">
              ...
              <ul>
                ...
                <li><strong>Horaires :</strong> Du lundi au vendredi de 10h à 13h et de 14h à 21h, le samedi de 10h à 13h et de 14h à 18h (CET)</li>
              </ul>
            </div>
          </section>
