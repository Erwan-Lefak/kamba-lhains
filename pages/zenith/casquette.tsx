...
export default function ZenithCasquette() {
  ...
  return (
    <>
      <Head>
        <title>Casquette Zénith - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Casquettes Zénith - Accessoire stylé et moderne de notre collection Zénith." />
