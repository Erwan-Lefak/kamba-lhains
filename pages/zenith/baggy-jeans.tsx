...
export default function ZenithBaggyJeans() {
  ...
  return (
    <>
      <Head>
        <title>Baggy Jeans Zénith - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Baggy Jeans Zénith - Style décontracté et confort optimal de notre collection Zénith." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Baggy Jeans Zénith ${index + 1}`}
                    width={400}
                    height={600}
