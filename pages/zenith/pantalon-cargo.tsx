...
export default function ZenithPantalonCargo() {
  ...
  return (
    <>
      <Head>
        <title>Pantalon Cargo Zénith - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Pantalons Cargo Zénith - Style utilitaire et moderne de notre collection Zénith." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Pantalon Cargo Zénith ${index + 1}`}
                    width={400}
                    height={600}
