...
export default function ZenithCeinture() {
  ...
  return (
    <>
      <Head>
        <title>Ceinture Zénith - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Ceintures Zénith - Accessoire élégant et fonctionnel de notre collection Zénith." />
