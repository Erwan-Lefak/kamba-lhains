...
export default function ZenithBonnet() {
  ...
  return (
    <>
      <Head>
        <title>Bonnet Zénith - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Bonnets Zénith - Accessoire stylé et confortable de notre collection Zénith." />
