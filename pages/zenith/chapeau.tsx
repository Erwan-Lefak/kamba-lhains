...
export default function ZenithChapeau() {
  ...
  return (
    <>
      <Head>
        <title>Chapeau Zénith - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Chapeaux Zénith - Accessoire raffiné et élégant de notre collection Zénith." />
