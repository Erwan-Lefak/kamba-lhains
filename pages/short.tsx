...
export default function Short() {
  ...
  // Filtrer les produits contenant "short" dans le nom ou la description
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez notre sélection de Shorts - Fraîcheur et style pour les beaux jours." />
      ...
      <main className="kambavers-page">
              ...
              <li>
                ...
                {showBasSubmenu && (
                  <ul className="submenu">
                    ...
                    <li><button onClick={() => router.push('/short')} className="submenu-item active">SHORT</button></li>
          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.textSection}>
              ...
              <p className={styles.collectionDescription}>
                Découvrez notre collection de shorts, parfaits pour allier fraîcheur et style durant les beaux jours. Des coupes modernes et des matières respirantes pour un confort optimal et une élégance décontractée en toute saison.
              </p>
            </div>
        ...
        <section className={styles.threeProductsSection}>
          ...
          {/* Mobile Carousel */}
          {shortProducts.length > 0 && <MobileCarousel products={shortProducts} />}
        </section>
        </div>
      </main>
