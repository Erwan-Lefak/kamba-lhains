...
export default function Aube() {
  ...
  // Filtrer les produits sweatpants et sous-vêtements
  const aubeProducts = products.filter(product => {
    return product.id === 'asabili-sweatpants' || product.id === 'calecon-champion';
  });

  return (
    <>
      <Head>
        <title>Aube - Kamba Lhains</title>
        <meta name="description" content={t('meta.aube')} />
          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.textSection}>
              ...
              <p className={styles.collectionDescription}>
                {t('collections.aubeIntro')}
              </p>
            </div>

            <div className={styles.mediaSection}>
              <div className="aube-images-container">
                <div className="aube-image-wrapper">
                  <Image
                    src="/images/aube-hero-new.jpg?v=3"
          ...
          <section className={styles.twoProductsSection}>
            <div className={styles.twoProductsGrid}>
              <div className={styles.simpleProductSlot}>
                <Image
                  src="/images/aube-section2-new.jpg?v=2"
                  alt="Collection Aube"
                  width={1200}
                  height={800}
                  className={styles.collectionImage}
