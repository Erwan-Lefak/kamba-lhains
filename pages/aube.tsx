...
export default function Aube() {
  ...
  // Filtrer les produits de la catégorie "Aube"
  const aubeProducts = products.filter(product => {
    return product.category === 'Aube';
  });
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez notre collection Aube - Le début d'une nouvelle journée." />
          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.textSection}>
              ...
              <p className={styles.collectionDescription}>
                L'Aube représente le début d'une nouvelle journée, un moment de renouveau et de promesse. Cette collection capture l'essence de ces premiers instants lumineux, où la lumière naissante révèle la beauté du monde qui s'éveille.
              </p>
            </div>
