          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.textSection}>
              ...
              <p className={styles.collectionDescription}>
                Découvrez notre collection de ceintures, accessoires indispensables pour la finition parfaite de vos tenues. Des pièces élégantes et fonctionnelles qui apportent structure et style à chacun de vos looks.
              </p>
            </div>
