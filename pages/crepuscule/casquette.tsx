...
export default function CrepusculeCasquette() {
  ...
  return (
    <>
      <Head>
        <title>Casquette Crépuscule - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Casquettes de la collection Crépuscule - Mystère et élégance pour vos soirées sophistiquées." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Casquette Crépuscule ${index + 1}`}
                    width={400}
                    height={600}
