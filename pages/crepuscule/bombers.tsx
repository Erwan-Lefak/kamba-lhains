...
export default function Bombers() {
  ...
  // Filtrer le produit bombers pour Crépuscule
  const bombersProducts = products.filter(product => {
    return product.id === 'bombers-itoua-crepuscule';
  });
  ...
  return (
    <>
        ...
        <div className={`main-content ${isMenuVisible ? 'with-sidebar' : 'full-width'}`}>
          ...
          <section className={styles.newCollectionSection}>
            ...
            <div className={styles.mediaSection}>
              <div className="bombers-images-container">
                <div className="bombers-image-wrapper">
                  <Image
      ...
      <style jsx>{`
        ...
        .bombers-image-wrapper {
          flex: 1;
          height: 100%;
          overflow: hidden;
        }

        .bombers-image-wrapper img {
          width: 100%;
          height: 100%;
          object-fit: cover;
