...
export default function CrepusculeVesteEnJeans() {
  ...
  const vesteEnJeansProducts = products.filter(product => {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Vestes en Jeans de la collection Crépuscule - Mystère et élégance pour vos soirées sophistiquées." />
