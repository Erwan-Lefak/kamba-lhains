...
export default function CrepusculeCeinture() {
  ...
  return (
    <>
      <Head>
        <title>Ceinture Crépuscule - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Ceintures de la collection Crépuscule - Mystère et élégance pour vos soirées sophistiquées." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Ceinture Crépuscule ${index + 1}`}
                    width={400}
                    height={600}
