...
export default function CrepusculeSweatShirt() {
  ...
  const sweatShirtProducts = products.filter(product => {
    ...
    const descriptionMatch = Array.isArray(product.description) 
      ? product.description.some(desc => desc.toLowerCase().includes('sweat'))
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Sweat-Shirts Crépuscule - Style sophistiqué pour vos soirées urbaines." />
        ...
        <div className={`main-content ${isMenuVisible ? 'with-sidebar' : 'full-width'}`}>
          ...
          <section className={styles.gallerySection}>
            <div className={styles.galleryGrid}>
              {[
                'IMG_2999.jpeg', 'IMG_3037.jpeg', 'IMG_3038.jpeg', 'IMG_3039.jpeg',
                'IMG_3040.jpeg', 'IMG_3041.jpeg', 'IMG_3042.jpeg', 'IMG_3043.jpeg'
              ].map((imageName, index) => (
