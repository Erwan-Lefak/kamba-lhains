...
export default function CrepusculeChemise() {
  ...
  const chemiseProducts = products.filter(product => {
    ...
    const descriptionMatch = Array.isArray(product.description) 
      ? product.description.some(desc => desc.toLowerCase().includes('chemise'))
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Chemises Crépuscule - Style sophistiqué pour vos soirées urbaines." />
