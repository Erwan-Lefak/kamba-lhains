...
export default function CrepusculeSweatpants() {
  ...
  return (
    <>
      <Head>
        <title>Sweatpants Crépuscule - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Sweatpants de la collection Crépuscule - Mystère et élégance pour vos soirées sophistiquées." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Sweatpants Crépuscule ${index + 1}`}
                    width={400}
                    height={600}
