...
export default function CrepusculeChapeau() {
  ...
  return (
    <>
      <Head>
        <title>Chapeau Crépuscule - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Chapeaux de la collection Crépuscule - Mystère et élégance pour vos soirées sophistiquées." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Chapeau Crépuscule ${index + 1}`}
                    width={400}
                    height={600}
