        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <div className="content">
              ...
              <p>Cette déclaration d'accessibilité s'applique au site kambalhains.com.</p>
            </div>
          </section>
          ...
          <section className="section">
            ...
            <div className="content">
              <p>Le site kambalhains.com est en conformité partielle avec le Référentiel Général d'Amélioration de l'Accessibilité (RGAA) version 4.1 et les Web Content Accessibility Guidelines (WCAG) 2.1 niveau AA.</p>
          ...
          <section className="section">
            ...
            <div className="content">
              <p>L'accessibilité de kambalhains.com s'appuie sur les technologies suivantes :</p>
              <ul>
                <li>HTML5</li>
                <li>CSS3</li>
                <li>JavaScript</li>
          ...
          <section className="section">
            ...
            <div className="content">
              ...
              <ul>
                <li><strong>Email :</strong> info@kambalahains.net</li>
                <li><strong>Téléphone :</strong> +33 (0) 1 58 30 03 84</li>
                <li><strong>Adresse :</strong> 229 rue Saint-Honoré, 75001 Paris, France</li>
                <li><strong>Horaires :</strong> Du lundi au vendredi de 10h à 13h et de 14h à 21h, le samedi de 10h à 13h et de 14h à 18h</li>
              </ul>
            </div>
          </section>
