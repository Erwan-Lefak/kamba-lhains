          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.textSection}>
              ...
              <p className={styles.collectionDescription}>
                Le Zénith marque l'apogée, le point culminant où la lumière atteint son intensité maximale. Cette collection incarne l'excellence et la sophistication, révélant des pièces qui brillent par leur raffinement et leur caractère unique.
              </p>
            </div>
