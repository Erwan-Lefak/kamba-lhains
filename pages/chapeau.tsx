...
export default function Chapeau() {
  ...
  // Filtrer les produits contenant "chapeau" ou "hat" dans le nom ou la description
  const chapeauProducts = products.filter(product => {
    const nameMatch = product.name.toLowerCase().includes('chapeau') || 
    ...
    const descriptionMatch = Array.isArray(product.description) 
      ? product.description.some(desc => 
          desc.toLowerCase().includes('chapeau') || 
          desc.toLowerCase().includes('hat')
        )
      : product.description.toLowerCase().includes('chapeau') || 
  ...
  return (
    <>
      <Head>
        <title>Chapeau - Kamba Lhains</title>
        <meta name="description" content="Découvrez notre sélection de Chapeaux - Élégance et raffinement intemporel." />
      ...
      <main className="kambavers-page">
              ...
              <li>
                ...
                {showAccessoiresSubmenu && (
                  <ul className="submenu">
                    ...
                    <li><button onClick={() => router.push('/chapeau')} className="submenu-item active">CHAPEAU</button></li>
          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.textSection}>
              ...
              <p className={styles.collectionDescription}>
                Découvrez notre collection de chapeaux, symboles d'élégance et de raffinement intemporel. Des pièces sophistiquées qui apportent une touche de distinction et de caractère à chacune de vos tenues.
              </p>
            </div>
        ...
        <section className={styles.threeProductsSection}>
          ...
          <div className={styles.threeProductsGrid}>
            {chapeauProducts.length > 0 ? (
              chapeauProducts.map(product => (
              ...
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
                <p>Aucun chapeau disponible pour le moment.</p>
              </div>
            )}
          </div>
          
          {/* Mobile Carousel */}
          {chapeauProducts.length > 0 && <MobileCarousel products={chapeauProducts} />}
        </section>
        </div>
      </main>
