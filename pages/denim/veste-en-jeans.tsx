...
export default function VesteEnJeans() {
  ...
  // Filtrer les produits veste en jeans (gilet-1957 et veste-jane)
  const vesteJeansProducts = products.filter(product => {
    return product.id === 'gilet-1957' || product.id === 'veste-jane';
  });

  return (
    <>
      <Head>
        <title>Veste en Jeans - Kamba Lhains</title>
        <meta name="description" content="Découvrez notre veste en jeans 1957 - Une pièce unique en denim." />
      ...
      <main className="kambavers-page">
        ...
        <div className={`main-content ${isMenuVisible ? 'with-sidebar' : 'full-width'}`}>
          {/* Section Introduction Veste en Jeans */}
          <section className={styles.newCollectionSection}>
            <div className={styles.mediaSection}>
              <div className="veste-images-container">
                <div className="veste-image-wrapper">
                  <Image
                    src="/images/veste-jeans-hero.jpg"
                    alt="Veste en Jeans - Kamba Lhains"
                    width={600}
                    height={800}
        ...
        <section className={styles.threeProductsSection}>
          ...
          <div className={styles.threeProductsGrid}>
            {vesteJeansProducts.map(product => (
          ...
          {/* Mobile Carousel */}
          <MobileCarousel products={vesteJeansProducts} />
        </section>
        </div>
      </main>
