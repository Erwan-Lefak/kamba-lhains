        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <div className="content">
              ...
              <p><strong>Site internet :</strong> kambalhains.com</p>
            </div>
          </section>
          ...
          <section className="section">
            ...
            <div className="content">
              ...
              <p>Si vous constatiez une lacune, erreur ou ce qui paraît être un dysfonctionnement, merci de bien vouloir le signaler par email à info@kambalahains.net en décrivant le problème de la manière la plus précise possible.</p>
            </div>
          </section>
