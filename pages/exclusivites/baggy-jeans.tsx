...
export default function ExclusivitesBaggyJeans() {
  ...
  return (
    <>
      <Head>
        <title>Baggy Jeans Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Baggy Jeans exclusifs - Style décontracté et confort optimal pour vos tenues." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Baggy Jeans Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
