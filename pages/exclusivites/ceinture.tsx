...
export default function ExclusivitesCeinture() {
  ...
  return (
    <>
      <Head>
        <title>Ceinture Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Ceintures exclusives - Finition parfaite et élégance pour compléter vos tenues." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Ceinture Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
