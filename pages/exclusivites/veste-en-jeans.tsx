...
export default function ExclusivitesVesteEnJeans() {
  ...
  const vesteProducts = products.filter(product => {
    ...
    const descriptionMatch = Array.isArray(product.description) 
      ? product.description.some(desc => 
          ...
          desc.toLowerCase().includes('jacket')
        )
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Vestes en Jeans exclusives - Style intemporel et sophistication." />
            ...
            <div className={styles.threeProductsGrid}>
              {vesteProducts.length > 0 ? (
                ...
                <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
                  <p>Aucune veste en jeans exclusive disponible pour le moment.</p>
                </div>
              )}
            </div>
            
            {vesteProducts.length > 0 && <MobileCarousel products={vesteProducts} />}
          </section>
        </div>
      </main>
