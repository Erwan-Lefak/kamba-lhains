...
export default function ExclusivitesPantalonCargo() {
  ...
  return (
    <>
      <Head>
        <title>Pantalon Cargo Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Pantalons Cargo exclusifs - Fonctionnalité et style urbain pour vos tenues décontractées." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Pantalon Cargo Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
