...
export default function ExclusivitesUnderwear() {
  ...
  return (
    <>
      <Head>
        <title>Sous-vêtements Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Sous-vêtements exclusifs - Confort et qualité premium pour votre bien-être quotidien." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Sous-vêtements Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
