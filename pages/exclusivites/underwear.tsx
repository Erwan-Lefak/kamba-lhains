...
export default function ExclusivitesUnderwear() {
  ...
  return (
    <>
      <Head>
        <title>Underwear Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Underwear exclusifs - Confort et qualité premium pour votre bien-être quotidien." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Underwear Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
