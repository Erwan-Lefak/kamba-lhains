...
export default function ExclusivitesSac() {
  ...
  return (
    <>
      <Head>
        <title>Sac Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Sacs exclusifs - Praticité et style pour compléter vos tenues avec élégance." />
