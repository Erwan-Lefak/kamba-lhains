...
export default function ExclusivitesChapeau() {
  ...
  return (
    <>
      <Head>
        <title>Chapeau Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Chapeaux exclusifs - Élégance intemporelle et style raffiné pour vos looks." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Chapeau Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
