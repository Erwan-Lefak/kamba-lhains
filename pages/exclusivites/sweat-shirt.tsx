...
export default function ExclusivitesSweatShirt() {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Découvrez nos Sweat-Shirts exclusifs - Confort et style pour tous vos moments." />
          ...
          <section className={styles.newCollectionSection}>
            <div className={styles.mediaSection}>
              <div className={styles.imageContainer}>
                <Image
                  src="/exclu2.jpg"
                  alt="Collection Exclusivités - Kamba Lhains"
                  width={1200}
                  height={800}
