...
export default function ExclusivitesChemise() {
  ...
  return (
    <>
      <Head>
        <title>Chemise Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Chemises exclusives - Élégance et raffinement pour vos tenues." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Chemise Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
