...
export default function ExclusivitesTShirt() {
  ...
  return (
    <>
      <Head>
        <title>T-Shirt Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos T-Shirts exclusifs - Des pièces uniques alliant confort et raffinement." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`T-Shirt Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
