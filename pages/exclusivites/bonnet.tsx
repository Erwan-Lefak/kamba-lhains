...
export default function ExclusivitesBonnet() {
  ...
  return (
    <>
      <Head>
        <title>Bonnet Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Bonnets exclusifs - Chaleur et style pour compléter vos tenues." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Bonnet Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
