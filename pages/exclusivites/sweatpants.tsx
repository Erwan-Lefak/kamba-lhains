...
export default function ExclusivitesSweatpants() {
  ...
  return (
    <>
      <Head>
        <title>Sweatpants Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Sweatpants exclusifs - Confort suprême et style décontracté pour vos moments de détente." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Sweatpants Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
