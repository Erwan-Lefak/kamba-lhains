...
export default function ExclusivitesCasquette() {
  ...
  return (
    <>
      <Head>
        <title>Casquette Exclusivités - Kamba Lhains</title>
        <meta name="description" content="Découvrez nos Casquettes exclusives - Style urbain et protection solaire pour vos looks." />
              ...
              {[
                ...
                <div key={index} className={styles.gallerySlot}>
                  <Image 
                    ...
                    alt={`Casquette Exclusivités ${index + 1}`}
                    width={400}
                    height={600}
