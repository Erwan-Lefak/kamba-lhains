            ...
            <div style={{ backgroundColor: '#f8f8f8', padding: '30px' }}>
              ...
              <div style={{ fontSize: '11px', color: '#666', lineHeight: '1.6' }}>
                <div style={{ marginBottom: '15px' }}>
                  <span style={{ fontWeight: '500', color: '#333' }}>Email :</span><br />
                  presse@kambalahains.net
                </div>
                <div style={{ marginBottom: '15px' }}>
                  <span style={{ fontWeight: '500', color: '#333' }}>Téléphone :</span><br />
                  +33 (0) 1 58 30 03 84
                </div>
                <div style={{ marginBottom: '15px' }}>
                ...
                <div>
                  <span style={{ fontWeight: '500', color: '#333' }}>Disponibilité :</span><br />
                  Lundi au Vendredi 10h-18h CET
                </div>
              </div>
            </div>
          ...
          <div style={{ backgroundColor: '#fff', border: '1px solid #eee', padding: '40px' }}>
            ...
            <div style={{ fontSize: '11px', color: '#666', lineHeight: '1.8', textAlign: 'justify' }}>
              ...
              <p style={{ marginBottom: '20px' }}>
                ...
                ses créations principalement en ligne sur kambalhains.com, touchant une clientèle 
                internationale soucieuse de mode responsable.
              </p>

              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '20px', marginTop: '30px', padding: '20px', backgroundColor: '#f8f8f8' }}>
                <div>
