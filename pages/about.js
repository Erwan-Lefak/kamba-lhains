          ...
          <section className="story-section">
            <div className="story-content">
              ...
              <div className="story-image">
                <img 
                  src="https://via.placeholder.com/500x400/8B4513/FFFFFF?text=Tissage+Ancestral" 
            ...
            <div className="team-grid">
              <div className="team-member">
                <div className="member-photo">
                  <img 
                    src="https://via.placeholder.com/200x200/8B4513/FFFFFF?text=Fondatrice" 
                    alt="Fondatrice" 
                  />
                </div>
                <h3>Amina Kamba</h3>
              ...
              <div className="team-member">
                <div className="member-photo">
                  <img 
                    src="https://via.placeholder.com/200x200/8B4513/FFFFFF?text=Artisan" 
                    alt="Maître artisan" 
                  />
                </div>
              ...
              <div className="team-member">
                <div className="member-photo">
                  <img 
                    src="https://via.placeholder.com/200x200/8B4513/FFFFFF?text=Designer" 
                    alt="Designer" 
                  />
                </div>
                <h3>Sarah Lhains</h3>
